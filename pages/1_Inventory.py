...
# ==================================================
# LOAD DATA FUNCTION (CLEAN + CORRECT)
# ==================================================
...
with col2:
    if "EquipmentType" in df.columns:
        ...
        if category == "All":
            eq_list = sorted(df["EquipmentType"].unique())

        elif category == "SSOE":
            eq_list = sorted(df[df["Category"] == "SSOE"]["EquipmentType"].unique())

        else:
            eq_list = sorted(df[df["Category"] == "NON-SSOE"]["EquipmentType"].unique())
